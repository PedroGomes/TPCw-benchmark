...
public class Customer implements Entity {
    ...
    public Customer(String C_ID, String C_UNAME, String C_PASSWD, String C_LNAME, String C_FNAME, int C_PHONE, String C_EMAIL, Date since, Date lastLogin, Timestamp login, Timestamp expiration, double balance, double ytd_pmt, Date birthdate, String data, double C_DISCOUNT, Address address) {
        this.c_id = C_ID;
