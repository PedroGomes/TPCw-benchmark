...
public class Order implements Entity {
    ...
    public Order(String O_ID, String O_C_ID, Date O_DATE, double O_SUB_TOTAL, double O_TAX, double O_TOTAL, String O_SHIP_TYPE, Date shipDate, String O_STATUS, String billAddress, String O_SHIP_ADDR) {
        this.O_ID = O_ID;
        this.O_C_ID = O_C_ID;
        this.O_DATE = O_DATE;
