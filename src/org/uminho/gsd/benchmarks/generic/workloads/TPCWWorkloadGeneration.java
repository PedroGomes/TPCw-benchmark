...
public class TPCWWorkloadGeneration implements WorkloadGeneratorInterface {
    ...
    public TPCWWorkloadGeneration(ResultHandler handler, List<String> items, List<String> authors, Map<String, Double> workload, ProbabilityDistribution distribution, BenchmarkNodeID nodeID, int personal_number, ProgressBar progressBar) {
...
//       System.out.println("-------");
//       System.out.println("OP1 H:" + ((i1 / (operation_num * 1d)) * 100));
//       System.out.println("OP2 NP:" + ((i2 / (operation_num * 1d)) * 100));
//       System.out.println("OP3 BS:" + ((i3 / (operation_num * 1d)) * 100));
//       System.out.println("OP4 PD:" + ((i4 / (operation_num * 1d)) * 100));
//       System.out.println("OP5 S:" + ((i5 / (operation_num * 1d)) * 100));
//       System.out.println("OP6 CR:" + ((i6 / (operation_num * 1d)) * 100));
//       System.out.println("OP7 OI:" + ((i7 / (operation_num * 1d)) * 100));
//       System.out.println("OP8 AC:" + ((i8 / (operation_num * 1d)) * 100));
//       System.out.println("OP9 SC:" + ((i9 / (operation_num * 1d)) * 100));
//       System.out.println("OP10 BR:" + ((i10 / (operation_num * 1d)) * 100));
//       System.out.println("OP11 BC:" + ((i11 / (operation_num * 1d)) * 100));
//       System.out.println("-------");
        }
