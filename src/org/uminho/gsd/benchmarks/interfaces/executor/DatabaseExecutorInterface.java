...
/**
 * The class that implements this interface should run the operations given by the {@linkplain WorkloadGeneratorInterface workload generation client}  ,
 * and store important results in the result handler
 */
public interface DatabaseExecutorInterface {
     ...
     *
     * @param workload         the workload generator that supplies the methods to be executed.
     * @param nodeId           the benchmark node where the client is executing.
     * @param operation_number the number of operation to execute.
     */
