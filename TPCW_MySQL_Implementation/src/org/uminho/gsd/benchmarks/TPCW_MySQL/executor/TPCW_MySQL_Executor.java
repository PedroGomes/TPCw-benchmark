...
public class TPCW_MySQL_Executor implements DatabaseExecutorInterface {
    ...
    public TPCW_MySQL_Executor(String databaseName, String user, String password, Map<String, String> read_paths, Map<String, String> write_paths, int number_clients) {
