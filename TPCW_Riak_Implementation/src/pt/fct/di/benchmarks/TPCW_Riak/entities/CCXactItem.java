...
public class CCXactItem implements Entity {
	...
	public String CX_CC_EXPIRY;
	/* String authId;*/
	public  double CX_XACT_AMT;
	public  String CX_XACT_DATE;
	public  int CX_CO_ID;
    ...
    public CCXactItem(String type, long num, String name, String expiry, double total, String shipDate, String order, int country) {
